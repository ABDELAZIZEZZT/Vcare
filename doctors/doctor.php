        ...
        <div class="d-flex flex-column gap-3 details-card doctor-details">
          <div class="details d-flex gap-2 align-items-center">
            ...
            <div class="details-info d-flex flex-column gap-3">
              <h4 class="card-title fw-bold"><?php echo $_POST['name']?></h4>
          ...
          <hr />
          <form class="form" action="c_boking.php" method="post">
            <div class="form-items">
              ...
              <!-- <div class="mb-3">
                <label class="form-label required-label" for="status"
                  >status</label
                >
                <input type="text" class="form-control" id="status" name="status" required />
              </div> -->
              <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $_POST['id']?>" />
