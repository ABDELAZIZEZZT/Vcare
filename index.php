                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                    <div class="d-flex gap-3 flex-wrap justify-content-center" role="group">
                        ...
                        <a type="button" class="btn btn-outline-light navigation--button"
                            href="./majors_.php">majors</a>
                        <a type="button" class="btn btn-outline-light navigation--button"
                            href="./doctors/index.php">Doctors</a>
                           
                            <a type="button" class="btn btn-outline-light navigation--button" href="./login.html">login</a>
                            <?php if ($_SESSION['role']=="admi"):?>
                            <a type="button" class="btn btn-outline-light navigation--button" href="./dashbord.php">AsAdmin</a>
                            <?php endif; ?>
        ...
        <div class="container">
            ...
            <div class="majors-grid">
                <div class="card p-2" style="width: 18rem;">
                    <img src="assets/images/majors/<?php echo $value['image']?>" class="card-img-top rounded-circle card-image-circle"
                        alt="major">
                    <div class="card-body d-flex flex-column gap-1 justify-content-center">
                        <h4 class="card-title fw-bold text-center"><?php echo $value['titel']?></h4>
                        <form action="./doctors/index.php" method="post">
                            <button class="btn btn-outline-primary card-button" name="browse">Browse Doctors</button>
                            <input type="hidden" name="titel" value="<?php echo $value['titel']?>">
                        </form>
                    </div>
        ...
        <div class="row gap-2">
            ...
            <div class="col-sm order-sm-2">
                ...
                <div class="links d-flex gap-2 flex-wrap">
                    ...
                    <a href="./majors_.php" class="link text-white">Majors</a>
